...
import com.ust.springboot.todos.service.AdminService;
...
public class AdminController {
    ...
    public UserResponse promoteToAdmin(@Min(value = 1) @PathVariable long userId){
    ...
    public void deleteUser(@Min(value = 1) @PathVariable long userId){
