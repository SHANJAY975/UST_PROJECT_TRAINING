...
import com.ust.springboot.todos.service.TodoService;
...
public class TodoController {
    ...
    @ResponseStatus(HttpStatus.OK)
    @PutMapping("/{id}")
    public TodoResponse toggleTodoCompletion(@PathVariable @Min(value = 1) long id){
    ...
    @DeleteMapping("/{id}")
    public void deleteTodo(@PathVariable @Min(value = 1) long id) {
